...
export const HOW_AFFECTS_ME_WORKS: TrustDocument = {
  ...
  sections: [
      ...
      blocks: [
        paragraph(
          'Affects me is a shortlist: the current notices that, based on your choices and on facts ' +
            'stated in the official notice, may be relevant to you. It is built from two things: ' +
            'what you chose in Personalization, and what the government notice itself says. ' +
    ...
    },
    {
      ...
      blocks: [
        ...
        bullets([
          ...
          'If a notice says “undeclared allergen” without naming it, it is never excluded, because the unnamed allergen could be yours.',
    ...
    },
    {
      ...
      blocks: [
        paragraph(
          'Recall alerts are decided by the same relevance evaluation as the Affects me list, so what ' +
            'the app shows and what it sends can never disagree. Until you choose a state, alerts ' +
            'are not narrowed at all, and every new recall alert qualifies, because allergen and store ' +
