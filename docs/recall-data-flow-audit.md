...
revised for C7.1 (installation data deletion) at HEAD `c069199`; bounded
offline spot re-verification 2026-09-05 (D1 — dependency delta, read-path
identity, feed-cache no-identity pin; the §6 bundle scans were NOT re-run
and remain dated 2026-08-28 — see the re-verification note in
`recall-launch-blockers.md` §5). Every fact
...
| expo-file-system (direct since C8 — feed cache store)                                                                       | FS for expo internals + feed cache                                           | —                       | local files (public recall cache) | Yes                                                                     | FileTimestamp 0A2A.1+3B52.1, DiskSpace E174.1+85F4.1 | No                              |
